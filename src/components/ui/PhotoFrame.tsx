 ...
 *
 * Enquanto o arquivo autorizado não estiver em `public/factory/`, mostra uma
 * composição gráfica inspirada em dobras de papel e faca de corte — nunca uma
 * foto genérica de banco de imagem. Assim que o arquivo existir, ele aparece
...
export function PhotoFrame({
  ...
  return (
    ...
    >
      {!failed ? (
        // eslint-disable-next-line @next/next/no-img-element -- precisa de onError para cair no placeholder quando a foto ainda não foi autorizada.
        <img
          src={src}
          alt={alt}
